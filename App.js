...
const players = [
  { id: 0, name: 'Marvin', kills: 13 },
  { id: 1, name: 'Nico', kills: 20 },
  { id: 2, name: 'Philipp', kills: 17 }
];
    ...
    <View style={styles.container}>
      <View style={styles.tableWrapper}>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'center', marginBottom: 10}}>
          <Text style={{color: 'white', marginRight: 2}}>Overview</Text>
          <Icon style={[styles.angleIcon, {transform: [{rotate: '180deg'}]}]} name='angle-down' type='font-awesome' color='white'/>
        </View>
      </View>
